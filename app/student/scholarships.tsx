  ...
  return (
    ...
    >
      ...
      <View>
        ...
        <Text style={[typography.bodyStrong, { color: c }]}>
          {value}
        </Text>
      </View>
    </View>
...
function ScholarshipCard({
  ...
  return (
    ...
    >
      ...
      <View
        style={{
          padding: compact ? spacing(3) : spacing(5),
          gap: compact ? spacing(2) : spacing(4),
        }}
      >
        <View
          style={{
        ...
        >
          {!compact && (
            ...
            >
              <Ionicons
                name={STATUS_ICONS[scholarship.status]}
                size={20}
                color={vc.text}
              />
            </View>
          ...
          <View
            style={{
              ...
              backgroundColor: isUrgent
                ...
                : colors.surfaceAlt,
              borderWidth: 1,
              borderColor: isUrgent ? `${colors.danger}33` : colors.border,
            }}
          >
            <Ionicons
              name="time-outline"
        ...
        >
          ...
          >
            <Text
              style={[
                typography.label,
                { color: colors.primary, fontSize: compact ? 10 : undefined },
              ]}
            >
              Details
            </Text>
...
function SidebarPanel({
  ...
  const intlCount = scholarships.filter(
    (s) => s.category === 'International'
  ).length;
  const urgentCount = scholarships.filter((s) => s.daysLeft <= 7).length;
  const qualifyCount = scholarships.filter(
    (s) => s.status === 'You May Qualify'
  ).length;
      ...
      >
        ...
        <View style={{ padding: spacing(6), gap: spacing(4) }}>
          ...
          <View style={{ gap: spacing(3) }}>
            {[
              ...
              >
                ...
                <Text style={[typography.bodyStrong, { color }]}>
                  {value}
                </Text>
              </View>
            ))}
          ...
          >
            ...
            >
              💡 Tap any scholarship card to view full details, eligibility criteria,
      ...
      <View style={{ padding: isMobile ? spacing(4) : spacing(7) }}>
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            <Text
              style={[
                typography.hero,
                {
                  ...
                  lineHeight: isMobile ? 26 : undefined,
                },
              ]}
            >
            ...
            >
              Discover scholarships and bursaries suited to your profile. Stay on
              top of deadlines and explore every opportunity available to you.
            </Text>
          </View>
    ...
    >
      ...
      >
        ...
        <Text
          style={[
            typography.caption,
            { color: colors.textMuted, fontSize: isMobile ? 11 : undefined },
          ]}
          numberOfLines={1}
        >
